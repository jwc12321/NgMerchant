...
import com.nenggou.slsm.common.unit.SystemUtils;
...
public class SinglePixelActivity extends AppCompatActivity {
    ...
    protected void onDestroy() {
        ...
        if(! SystemUtils.isAPPALive(this,StaticData.PACKAGE_NAME)){
            Intent intentAlive = new Intent(this, MainFrameActivity.class);
