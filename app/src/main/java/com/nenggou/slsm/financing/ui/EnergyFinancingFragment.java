...
public class EnergyFinancingFragment extends BaseListFragment<FinancingItemInfo> implements FinancingContract.FinancindListView, HeaderViewLayout.OnRefreshListener, FinancingTypeItemAdapter.ItemClickListener{
    ...
    public static EnergyFinancingFragment newInstance() {
        EnergyFinancingFragment fragment = new EnergyFinancingFragment();
        return fragment;
    }
